...
export const TASKS = [
  ...
  t("LOGISTICS","Finalize guest count and reception layout","Both","2026-09-06","done","Includes adults/children, unused seats, high chairs, and final table assignments."),
  t("LOGISTICS","Finalize seating chart","Both","2026-09-12","doing","Use the Seating tab."),
  t("ATTIRE","Alex take suit to be fitted","Alex","2026-09-11"),
  t("VENDORS","Send final/updated guest count to venue and caterer","Ally","2026-09-07","done","Include dietary restrictions and vendor meals if requested."),
  ...
  t("VENDORS","Create and send photographer shot list","Ally","2026-09-08","doing","Include family formals with names, must-have people, details/decor, first look, and getting-ready locations."),
  ...
  t("DECOR","Inventory all decor and note anything missing","Ally","2026-09-08","doing","Signs/stands, frames, guest book, card box, ceremony decor."),
  t("DECOR","Ally get cocktail table linens from Danielle","Ally","2026-09-08"),
  ...
  t("DECOR","Order bubbles for send off","Alex","2026-09-09"),
  ...
  t("LOGISTICS","Finalize and purchase remaining beer, wine, liquor, mixers, and garnishes","Both","2026-09-26","todo","Include Italicus Spritz ingredients, mixers, and garnishes."),
...
function tr(date, stop, time, type, title, details, extra){ return {date, stop, time: time||"", type, title, details: details||"", conf:"", link:"", status:"planned", ...(extra||{})}; }
export const TRIP_SEED = [
  ...
  tr("2026-10-18","chq","14:00","stay","Residenza Vranas Boutique Hotel · Oct 18–22","Superior Sea View Suite with heated plunge pool and balcony, 90 m², 1st floor over the Venetian harbour. Breakfast, bottle of wine, welcome dessert and parking included. Check-in 2 PM, check-out 11 AM. 26 Zampeliou Str, Old Town Chania · +30 28210 02933 · info@vranasresidenza.com. Free cancellation until 6 PM Sept 27; charged in full 21 days before arrival. Private parking 200 m away (reserve it).",{status:"booked", conf:"58683874", link:"https://vranasresidenza.com"}),
